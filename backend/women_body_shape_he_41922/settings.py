"""
Django settings for women_body_shape_he_41922 project.
...
ROOT_URLCONF = 'women_body_shape_he_41922.urls'
...
WSGI_APPLICATION = 'women_body_shape_he_41922.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "women_body_shape_he_41922 API",
    "DESCRIPTION": "API documentation for women_body_shape_he_41922 App",
    "VERSION": "v1",
}
